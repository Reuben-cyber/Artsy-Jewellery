...
if($option['header_topbar_show']==false){ ?>
<div class="top-header <?php //echo esc_attr( $headerClass ); ?>">
            ...
            <div class="col-lg-9 col-md-9 col-sm-6">
                <div class="header-contact text-lg-left text-sm-center text-center">
                    <ul>
                        ...
                        <li><i class=""></i> <a href="<?php //echo esc_attr( 'tel:' . $option['header_phone'] ); ?>"><?php//echo esc_html( $option['header_phone'] ); ?></a></li>
                        <?php// } ?>

                        <?php //if( !empty($option['header_email']) ){ ?>
                        <li><i class=""></i> <a href="<?php //echo esc_attr( 'mailto:' . sanitize_email( $option['header_email'] ) ); ?>"><?php //echo esc_html( $option['header_email'] ); ?></a></li>
                        <?php //} ?>
                    </ul>
                </div>
            </div>
